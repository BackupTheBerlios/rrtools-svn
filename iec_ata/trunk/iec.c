...
/* variables *************************************************************/
volatile uint8_t devicenumber = 14;
volatile bool_t attention;
volatile bool_t attention_delay;

/* functions *************************************************************/

bool_t iecListen (uint8_t *data, bufferSize_t maxBytes, bufferSize_t *bytesReceived) {
	bool_t eoi = FALSE;
	...
	*bytesReceived = 0;
	...
	/* TODO: find the correct delay. 60µs EOI aclolage
